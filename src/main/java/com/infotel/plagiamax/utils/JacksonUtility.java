...
public class JacksonUtility {
	 ...
	 * @return the json-string representing the data, or an empty-string; will not
	 *         return null
	 * @throws JacksonUtilityException if there was an error converting the map-data
	 *                                 into a json-string
	 */
	public static String GET_JSON_STRING_FROM_MAP(Map<String, Object> dataMap) throws Exception {

		/* NOTE: per Jackson-dox, the map must be of type <String, Object> */

		if (dataMap == null || dataMap.isEmpty()) {
			System.out.println("cannot convert data from map into json when map is null/empty");
	 ...
	 * 
	 * @throws JacksonUtilityException if there was an error converting the
	 *                                 json-string into map-data
	 */
	@SuppressWarnings("unchecked")
	public static Map<String, Object> GET_JSON_STRING_AS_MAP(String jsonResponse) throws Exception {

		/*
		 * NOTE: @SuppressWarnings("unchecked") because Jackson-dox state that a
		 * JSON-Object will always return as Map<String, Object>
		 * http://wiki.fasterxml.com/JacksonDataBinding
		 */

		if (jsonResponse == null || jsonResponse.trim().isEmpty()) {
			System.err.println("jsonResponse was null/empty, returning empty map; was: '" + jsonResponse + "'");
