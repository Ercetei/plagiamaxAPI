...
/**
 * The Abstract Class BetLineContract.
 */
public abstract class BetLineContract {

	/** The Constant MOMENTODDS. */
	public static final String MOMENTODDS = "momentodds";

	/** The Constant ASSOCIATION_BET. */
	public static final String ASSOCIATION_BET = "bet";

	/** The Constant ASSOCIATION_BETTYPE. */
